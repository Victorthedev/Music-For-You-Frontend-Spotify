...
const Howitworks = () => {
  ...
  return (
    <div className='bg-[#0C0C0C] py-20 grid gap-20 xl:w-[92%] mx-auto'>
        <h3 className='font-semibold md:text-5xl text-[40px] text-secondary mx-auto h-fit'>
...
const Howitworks1 = ({ currentStep, setCurrentStep }) => {
  ...
  return (
        <section className='h-fit mx-auto xl:flex xl:flex-row flex flex-col-reverse gap-10'>
            <div className='w-[92%] h-fit m-auto grid gap-20'>
                ...
                <div className='bg-transparent w-[92%] h-fit rounded-[32px] md:p-6 p-4 border border-opacity-12 mx-auto'>
                    <div className='w-full md:h-[600px] h-[500px] rounded-3xl sm:px-20 md:py-20 py-10 px-4 bg-white bg-opacity-5 grid gap-10'>
                        <div className='w-[92%] grid gap-2 text-center mx-auto'>
                        ...
                        <div className='w-[92%] grid gap-6 h-fit mx-auto'>
                            <LoginBtn 
                                image={spotify} 
                            />
                            <LoginBtn 
...
const Howitworks2 = ({ setCurrentStep }) => {
    ...
    return (
    <section className='h-fit w-fit mx-auto xl:flex xl:flex-row flex flex-col-reverse gap-10'>
        <div className='w-[92%] h-fit m-auto grid gap-20'>
            <div className='gap-[27px] grid'>
            ...
            <div className='bg-transparent w-[92%] h-fit rounded-[32px] p-6 border border-opacity-12 mx-auto'>
                <div className='w-full md:h-[600px] h-[400px] rounded-3xl sm:px-20 md:py-20 py-10 px-4 bg-white bg-opacity-5 grid gap-10'>
                    <div className='w-[92%] grid gap-2 text-center mx-auto'>
                        <h5 className='font-light text-[30px] capitalize text-primary' >create a playlist</h5>
                    ...
                    <div className='w-[92%] grid gap-6 h-fit mx-auto'>
                        ...
                        <div className='flex gap-4'>
                            ...
                            <button 
                                className='py-4 px-10 flex gap-4 text-primary text-base font-semibold h-fit w-full purple-gradient border-primary rounded-lg justify-center items-center'
  ...
  return (
        <section className='h-fit w-fit mx-auto xl:flex xl:flex-row flex flex-col-reverse gap-10'>
            <div className='w-[92%] h-fit m-auto grid gap-20'>
                ...
                <div className='bg-transparent w-[92%] h-fit rounded-[32px] p-6 border border-opacity-12 mx-auto'>
                    <div className='w-full mx-auto md:h-[600px] h-[400px] rounded-3xl sm:px-20 md:py-20 py-10 px-4 bg-white bg-opacity-5 grid gap-10'>
                        <div className='sm:w-[416px] w-[300px] grid gap-2 text-center mx-auto'>
                            <div className='grid gap-4 items-center justify-center text-center'>
                              <img src={imgDefault} alt="" className='sm:w-[250px] w-[180px] h-auto rounded-3xl'/>
